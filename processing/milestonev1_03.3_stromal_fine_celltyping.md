...
celltype_assignment=c(
  'stromal_7'='endothelial',
  'stromal_6'='endothelial',
  'stromal_5'='endothelial',
  'stromal_10'='endothelial',
  ...
  'stromal_11'='stromal_unknown')



#get clusters with cancer clones assigned, assign the whole cluster as cancer
stromal@metadata$celltype<-"NA"
stromal@metadata$celltype<-celltype_assignment[stromal@metadata$fine_cluster_leidenclus]
...
hm<-table(stromal@metadata$Group,stromal@metadata$celltype)
